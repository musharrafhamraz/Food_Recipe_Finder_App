...
class _RecipeScreenState extends State<HomeScreen> {
  ...
  Future<List<Recipe>> fetchRecipes({String query = ''}) async {
    ...
    if (response.statusCode == 200) {
      ...
      List<dynamic> recipesJson =
          query.isNotEmpty ? jsonResponse['results'] : jsonResponse['recipes'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 63, 63, 72),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //         onSubmitted: (query) {
                //           setState(() {
                //             futureRecipes = fetchRecipes(query: query);
                //           });
                //         },
                //       ),
                //     ),
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        return Center(
                          child: FAProgressBar(
                              ...
                              currentValue: 99.9,
                              progressColor: const Color(0xFFFFFD57),
                              displayText: '%',
                              displayTextStyle:
